...
class StudentProfile extends Component {
  ...
  async componentDidMount() {
    ...
    this.setState({
      ...
      phone_no: this.props.student.phone_no,
      country: this.props.student.country,
      education_info: this.props.student.education_info,
    });
  }
  ...
  onSubmitHandler = (e) => {
    ...
    const { name, email, education_info, city, country, phone_no } = this.state;
    e.preventDefault();
    this.props.update({
      name,
      email,
  ...
  render() {
    ...
    let register_form = (
      <div>
        <h1 className='large primary-text'>Update Profile</h1>
        <form className='form' onSubmit={(e) => this.onSubmitHandler(e)}>
          ...
          <div className='form-group'>
            <input
              ...
              name='education_info'
              value={this.state.education_info}
              required
            />
          </div>
